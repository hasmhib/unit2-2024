...
## Criteria A: Planning
UWC ISAK JAPAN is the boading high school located on the top of the hill. One student, John goes to the nearest supermarket to buy vegetables. It takes more than 1 hour on foot, so he decided to grow begetables in his house. However he's not sure whether he should grow them outside or inside, so he wants to compare the temperature and humidity accurately with cheap price. Also he desires the backup just in case he loses the data as he broke the PC and lost the data previously. 
