...
## Criteria A: Planning
An international school is the boading high school located on the top of the hill in Japan. A student, whos name is John, goes to the nearest supermarket to buy vegetables such as tomatoes and beans. It takes more than an hour on foot, so he decided to grow vegetables in his room so that he can spend another time to do something else instead of going to the supermarket. However he is not sure which place is the most efficient place for the plants to grow, so he decided to use data to compare the temperature and humidity. Also he wants data to be backedup just in case he loses the data as he broke the computer and he may lost the previous data. 
